...
if __name__ == '__main__':
    ...
    if not Multi_GPU:
        ...
        print(m.summary())
        model = multi_gpu_model(m, 3)  # Split batch to sub-batches # GPU check  #0.0005 0.9con   1e-6
        model.compile(loss='categorical_crossentropy', optimizer=SGD(lr=0.001, momentum=0.2,decay=0), metrics=['accuracy'])
