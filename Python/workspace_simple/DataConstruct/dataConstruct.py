...
if __name__ == '__main__':
    ...
    #
    #     t1 = time.clock()
    #     data = imgProcess("data/data", file_index=index, frame_num=frameNum, size=(64, 64), store=storeFile)
    #     t2 = time.clock()
    #     print(t2 - t1)
    #     del data

    for i in range(0,len(dev_index)):
        storeFile = 'dev'+str(i+1)+".dat" #
        print(storeFile)
        ind = dev_index[i] #
    ...
    #
    # for i in range(0,len(test_index)): #
    #     storeFile = "outputDAT/testCls"+str(i+1)+".npy" #
    #     print(storeFile)
    #     ind = test_index[i] #
    #     index = test[ind[0]:ind[1]] #
    #     print(ind,index.shape)
    ...
    #
    # for i in range(0,len(dev_index)): #
    #     storeFile = "outputDAT/devCls"+str(i+1)+".npy" #
    #     print(storeFile)
    #     ind = dev_index[i] #
    #     index = dev[ind[0]:ind[1]] #
    #     print(ind,index.shape)
    ...
    #
    # for i in range(0,len(train_index)): #
    #     storeFile = "outputDAT/trainCls"+str(i+1)+".npy" #
    #     print(storeFile)
    #     ind = train_index[i] #
    #     index = train[ind[0]:ind[1]] #
    #     print(ind,index.shape)
