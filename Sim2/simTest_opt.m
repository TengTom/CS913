...
population.template = ones(512,512);
...
population.clustprob = 1; % 0.0

% Variance for clustered cells
population.spatvar = 0;% 0.05
...
measurement.autofluorscale = 0;%0.05

% Variance of noise for ccd detector
measurement.ccd = 0; % 0.0001
...
% Cytoplasm radius
cell_obj.cytoplasm.radius = 50; % 25

% Parameters for random shape
cell_obj.cytoplasm.shape = [0 0];% [0.3 0.05]

% Parameters for texture: persistence, 1st octave, last octave, and
% intensity bias
cell_obj.cytoplasm.texture = [0.0 2 4 0.2];% [0.9 2 8 0.2]

%%% Nuclei (see cytoplasm parameters for details)
cell_obj.nucleus.include = 1;
cell_obj.nucleus.radius = 20; % 10
cell_obj.nucleus.shape = [0 0];% [0.1 0.1]
cell_obj.nucleus.texture = [0.0 2 4 0.4]; % [0.5 2 5 0.2]
