...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[out] = generate_objects(cell_obj,population,seed)
...
rng(seed);
x_range=[size(population.template,1)*0.2,size(population.template,1)*0.8];
x_range = round(x_range);
y_range=[size(population.template,2)*0.2,size(population.template,2)*0.8];
