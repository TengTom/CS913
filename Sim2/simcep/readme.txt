...
Modified:!!!
parameter: number of cells and clusters

functions:
generate_object: code for define cluster centers (ensure staying around the middle of the image)
                 allow seed arguments (reproduce cluster center or for continous sim latter)
